...
import com.thaisq.service.database.AccountRepository;
...
public class HomeController {
	...
	@RequestMapping("/home/index?all")
	public String getAll(Model model, @RequestParam("p") Optional<Integer> p,@RequestParam("category") Optional<String> category) {
			String ctegory = category.orElse("%");
			model.addAttribute("category",ctegory);
	...
	@RequestMapping("/home/admin/orders/{id}")
	public String getBuyInfo(Model model,@PathVariable("id") int id) {
		model.addAttribute("orderDt",productRepository.findBuyOrdersDetailByOrderId(id));
		return "home/admin";
	}
}

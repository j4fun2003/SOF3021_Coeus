...
<body>
	<div class="menu__nav">
		...
		<div class="menu-items">
			<ul class="nav-links">
				<li><a href="#"> <i class='bx bx-bar-chart-alt'></i> <span
						class="link-name">Thống kê</span>
				</a></li>
				<li><a href="#product"> <i class='bx bx-box'></i> <span
						class="link-name">Quản lý sản phẩm</span>
				</a></li>
				<li><a href="#user"> <i class='bx bx-user'></i> <span
						class="link-name">Quản lý user</span>
				</a></li>
			</ul>

			<ul class="logout-mode">
				<li><a href="/home/index#"> <i class="uil uil-signout"></i> <span
						class="link-name">Trở về</span>
				</a></li>
	...
	<section class="dashboard">
		...
		<div class="dash-content">
			<div class="overview">
				<div class="title">
					<i class='bx bx-bar-chart-alt'></i> <span class="text">Thống
						kê</span>
				</div>

				<div class="boxes">
					<div class="box box1">
						<i class='bx bx-money'></i> <span class="text">Turnover</span> <span
							class="number"> <fmt:formatNumber value="${turnover}"
								type="currency" currencySymbol="VND" />
						</span>
					</div>
					<div class="box box2">
						<i class='bx bx-home-smile'></i> <span class="text">Depot</span> <span
							class="number"> ${depot} </span>
					</div>
					<div class="box box3">
						<i class='bx bx-cart-download'></i> <span class="text">Sold</span>
			...
			<div class="activity" id="order">
				<div class="title">
					<i class='bx bx-receipt'></i> <span class="text">Đơn hàng</span>
				</div>
				<div class="activity-data">
					<div class="data names">
						<span class="data-title">Mã đơn hàng</span>
						<c:forEach var="order" items="${adminOrders.content}">
							<span class="data-list">${order.id}</span>
						</c:forEach>
					</div>
					<div class="data email">
						<span class="data-title">Tên người nhận</span>
						<c:forEach var="order" items="${adminOrders.content}">
							<span class="data-list">${order.account.fullname}</span>
						</c:forEach>
					</div>
					<div class="data joined">
						<span class="data-title">Ngày đặt</span>
						<c:forEach var="order" items="${adminOrders.content}">
					...
					<div class="data type">
						...
						<c:forEach var="order" items="${adminOrders.content}">
							<span class="data-list">${order.address}</span>
						</c:forEach>
					</div>
					<div class="data status">
						<span class="data-title">Trạng thái đơn hàng</span>
						<c:forEach var="order" items="${adminOrders.content}">
					...
					<div class="data status">
						<span class="data-title">Ghi chú</span>
						<c:forEach var="order" items="${adminOrders.content}">
							<span class="data-list">${order.note}</span>
						</c:forEach>
					</div>
					<div class="data status">
						<span class="data-title">Giá</span>
						<c:forEach var="order" items="${adminOrders.content}">
							<span class="data-list">${order.price}</span>
						</c:forEach>
					</div>
					<div class="data status">
						<span class="data-title">Chi tiết</span>
						<c:forEach var="order" items="${adminOrders.content}">
							<span class="data-list"><a
								href="/home/admin/orders/${order.id}" class="data-list">Xem</a></span>
						</c:forEach>
					</div>
				</div>

				<div class="btn-changepage">
					<a class="btn btn-primary offset-3" href="/home/admin?p=0#order">Trang
						đầu</a>
					<c:if test="${adminOrders.number == 0 }">
						<a class="btn btn-primary" href="#order">Trước</a>
					</c:if>
					<c:if test="${adminOrders.number != 0 }">
						<a class="btn btn-primary"
							href="/home/admin?p=${adminOrders.number-1}#order">Trước</a>
					</c:if>
					<c:if test="${adminOrders.number >= (adminOrders.totalPages - 1)}">
						<a class="btn btn-primary" href="#order">Sau</a>
					</c:if>
					<c:if test="${adminOrders.number < (adminOrders.totalPages - 1)}">
						<a class="btn btn-primary"
							href="/home/admin?p=${adminOrders.number+1}#order">Sau</a>
					</c:if>
					<a class="btn btn-primary"
						href="/home/admin?p=${adminOrders.totalPages-1}#order">Trang
						cuối</a>
				</div>
		...
		<div class="dash-content" id="product">
			<div class="activity">
				<div class="title">
					<i class='bx bx-box'></i> <span class="text">Sản phẩm</span>
				</div>
				<div class="activity-data">
					...
					<div class="data names">
						...
						<span class="data-title data__list-style-name"
							style="width: 120px;">Mã sản phẩm</span>
					...
					<div class="data email">
						<span class="data-title data__list-style-name">Tên sản phẩm</span>
						<c:forEach var="product" items="${adminProducts.content}">
					...
					<div class="data joined">
						...
						<c:forEach var="product" items="${adminProducts.content}">
							<span class="data-list data__list-style-image"> <img
								style="width: 42px; height: 42px; margin: 12px; border: 1px solid #9999;"
								src="../../../images/product/${product.image1}" />
							</span>
						</c:forEach>
					</div>
					...
					<div class="data type">
						...
						<c:forEach var="product" items="${adminProducts.content}">
							<span class="data-list data__list-style-image"> <img
								style="width: 42px; height: 42px; margin: 12px; border: 1px solid #9999;"
								src="../../../images/product/${product.image2}" />
							</span>
						</c:forEach>
					</div>
					<div class="data status">
						...
						<c:forEach var="product" items="${adminProducts.content}">
							<span class="data-list data__list-style-image"> <img
								style="width: 42px; height: 42px; margin: 12px; border: 1px solid #9999;"
								src="../../../images/product/${product.image3}" />
							</span>
						</c:forEach>
					...
					<div class="data status">
						...
						<c:forEach var="product" items="${adminProducts.content}">
							<span class="data-list data__list-style-image"> <img
								style="width: 42px; height: 42px; margin: 12px; border: 1px solid #9999;"
								src="../../../images/product/${product.image4}" />
							</span>
						</c:forEach>
					</div>
					<div class="data status">
					...
					<div class="data status">
						<span class="data-title data__list-style-name"
							style="width: 120px;">Chỉnh sửa</span>
						<c:forEach var="product" items="${adminProducts.content}">
							<span class="data-list data__list-style-name"><a
								href="/home/admin/edit/${product.id}" class="data-list">Edit</a></span>
						</c:forEach>
					</div>
					<div class="data status">
						<span class="data-title data__list-style-name">Xoá</span>
						<c:forEach var="product" items="${adminProducts.content}">
							<span class="data-list data__list-style-name"> <form:form
									action="/home/admin" modelAttribute="product"
				...
				<div class="btn-changepage">
					...
					<c:if test="${adminProducts.number != 0 }">
						<a class="btn btn-primary"
							href="/home/admin?p=${adminProducts.number-1}#product">Previous</a>
					</c:if>
					<c:if
						test="${adminProducts.number >= (adminProducts.totalPages - 1)}">
						<a class="btn btn-primary" href="#product">Next</a>
					</c:if>
					<c:if
						test="${adminProducts.number < (adminProducts.totalPages - 1)}">
						<a class="btn btn-primary"
							href="/home/admin?p=${adminProducts.number+1}#product">Next</a>
					</c:if>
					<a class="btn btn-primary"
						href="/home/admin?p=${adminProducts.totalPages-1}#product">Last</a>
				</div>
		...
		<div class="activity">
			<div class="title">
				<i class='bx bxl-dropbox'></i> <span class="text">Thêm sản
					phẩm</span>
			</div>
			<div class="activity-data">
				<form:form action="/home/admin" modelAttribute="product"
					enctype="multipart/form-data">
					<div class="row">
						<div class="col-6">
							<label for="floatingProductId">Mã sản phẩm</label>
				
						<div class="field">
							<form:input id="floatingProductId" path="id"
								placeholder="Product ID" class="form-control"/>
							<i class='fas fa-user'></i>
						</div>
				
					<label for="floatProductName">Tên sản phẩm</label>
			
						<div class="field">
							<form:input id="floatProductName" path="name" placeholder="Name" class="form-control" />
					...
					<label for="file-Image1">Image1</label>
						...
						<div class="field">
							<input type="file" name="attach-file1" id="file-Image1"
								placeholder="Image1" class="form-control">
					...
					<label for="file-Image2">Image2</label>
						...
						<div class="field">
							<input type="file" name="attach-file2" id="file-Image2"
								placeholder="Image2" class="form-control">
					...
					<label for="file-Image2">Image3</label>
						...
						<div class="field">
							<input type="file" name="attach-file3" id="file-Image3"
								placeholder="Image3" class="form-control">
					...
					<label for="file-Image4">Image4</label>
						...
						<div class="field">
							<input type="file" name="attach-file4" id="file-Image4"
								placeholder="Image4" class="form-control">

						</div>
					
					</div>
					<div class="col-6">
									<label for="floatProductColor">Tác giả</label>
					
						<div class="field">
							<form:input id="floatProductColor" path="color"
					...
					<label for="floatProductPrice">Giá</label>
			
						<div class="field">
							<form:input id="floatProductPrice" path="price"
								placeholder="Price" class="form-control" />

						</div>
				
					<label for="floatProductQuantity">Số lượng</label>
				
						<div class="field">
							<form:input id="floatProductQuantity" path="quantity"
					...
					<label for="floatManufactor">Manufactor</label>
						...
						<div class="field">
							<form:input id="floatManufactor" path="manufactor"
								placeholder="Manufactor" class="form-control" />

						</div>
				
					<label for="floatProductDiscount">Giá giảm</label>
				
						<div class="field">
							<form:input id="floatProductDiscount" path="discount"
								placeholder="Discount" class="form-control"/>

						</div>
				

					<label for="floatProductCategory">Thể loại</label>
				
						<div class="field">
							<form:input id="floatProductCategory" path="category"
								placeholder="Category Id" class="form-control"/>

						</div>
				
					<label for="floatProductDescription">Mô tả</label>
					<div class="message">
		...
		<div class="dash-content" id="user">
			<div class="activity">
				<div class="title">
					<i class='bx bx-user'></i> <span class="text">Người dùng</span>
				</div>

				<div class="activity-data">
					<div class="data names">
						<span class="data-title">Người dùng</span>
						<c:forEach var="item" items="${adminUsers.content}">
							<span class="data-list">${item.username}</span>
						</c:forEach>
					</div>
					<div class="data email">
						<span class="data-title">Mật khẩu</span>
						<c:forEach var="item" items="${adminUsers.content}">
							<span class="data-list">${item.password}</span>
						</c:forEach>
					</div>
					<div class="data joined">
						<span class="data-title">Tên đầy đủ</span>
						<c:forEach var="item" items="${adminUsers.content}">
							<span class="data-list">${item.fullname}</span>
						</c:forEach>
					</div>
					<div class="data type">
						<span class="data-title">Điện thoại</span>
						<c:forEach var="item" items="${adminUsers.content}">
					...
					<div class="data status">
						<span class="data-title">HÌnh</span>
						<c:forEach var="item" items="${adminUsers.content}">
							<span class="data-list">${item.photo}</span>
						</c:forEach>
					</div>
					<div class="data status">
						<span class="data-title">Vai trò</span>
						<c:forEach var="item" items="${adminUsers.content}">
				...
				<div class="btn-changepage">
					<a class="btn btn-primary offset-3" href="/home/admin?pUser=0#user">Trang
						đầu</a>
					<c:if test="${adminUsers.number == 0 }">
						<a class="btn btn-primary" href="#user">Trước</a>
					</c:if>
					<c:if test="${adminUsers.number != 0 }">
						<a class="btn btn-primary"
							href="/home/admin?pUser=${adminUsers.number-1}#user">Trước</a>
					</c:if>
					<c:if test="${adminUsers.number >= (adminUsers.totalPages - 1)}">
						<a class="btn btn-primary" href="#user">Sau</a>
					</c:if>
					<c:if test="${adminUsers.number < (adminUsers.totalPages - 1)}">
						<a class="btn btn-primary"
							href="/home/admin?pUser=${adminUsers.number+1}#user">Sau</a>
					</c:if>
					<a class="btn btn-primary"
						href="/home/admin?pUser=${adminUsers.totalPages-1}#user">Trang
						cuối</a>
				</div>

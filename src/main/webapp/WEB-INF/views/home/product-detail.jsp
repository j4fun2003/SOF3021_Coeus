		...
		<div class="card">
			...
			<div class="product-imgs">
				...
				<div class="img-select">
					<div class="img-item">
						<a href="#" data-id="1"> <img
							src="../images/product/${product.image1}" alt="productImg1">
						</a>
					</div>
					<div class="img-item">
						<a href="#" data-id="2"> <img
							src="../images/product/${product.image2}" alt="productImg2">
						</a>
					</div>
					<div class="img-item">
						<a href="#" data-id="3"> <img
							src="../images/product/${product.image3}" alt="productImg3">
						</a>
					</div>
					<div class="img-item">
						<a href="#" data-id="4"> <img
							src="../images/product/${product.image4}" alt="productImg4">
						</a>
					</div>
				</div>
			</div>
			...
			<div class="product-content">
				...
				<div class="product-price">
					<c:if test="${product.discount != 0}">
						<p class="last-price" style="#ccc">
							<span> <fmt:formatNumber value="${product.price}"
									type="currency" currencySymbol="VND" />
							</span>
						</p>
						<p class="new-price" style="font-size:1.5rem;font-weight:600;color:red !important">
							<span> <fmt:formatNumber value="${newPrice}"
									type="currency" currencySymbol="VND" />
							</span>
						</p>
					</c:if>
					<c:if test="${product.discount == 0}">
						<p class="new-price">
							New Price: <span> <fmt:formatNumber
									value="${product.price}" type="currency" currencySymbol="VND" />
							</span>
						</p>
					</c:if>
				</div>
				...
				<div class="product-detail">
					<h3>Mô tả về "${product.name}":</h3>
					<p>${product.description}</p>
					<ul>
						<li>Tác giả: <span>${product.color}</span></li>
						<li>Kho: <span>${product.quantity > 0 ? "Còn hàng":"Hết hàng"}</span></li>
						<li>Thể loại: <span>${product.category.name}</span></li>
					</ul>
				</div>
				<div class="purchase-info">
					...
					<c:if test="${product.quantity > 0}">
						<button class="cart-button" id="add-to-cart"
							data-product-id="${product.id}">
							<span class="add-to-cart">Thêm vào giỏ hàng</span> <span
								class="added">Đã thêm</span> <i class="fas fa-shopping-cart"></i>
